  ...
  return (
    <section className="bg-blue-800">
        <div className="flex flex-col items-center justify-center px-6 py-8 h-screen">
            <div className="w-full  shadow border max-w-md bg-yellow-200 border-yellow-200">
                <div className="p-6 space-y-6">
                    ...
                    <form className="space-y-6" action="post">
                        ...
                        <div>
                            <a href="#" className="text-sm text-gray-700 font-medium hover:underline">Forgot password?</a>
                        </div>
