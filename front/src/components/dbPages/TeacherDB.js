    ...
    <section className="bg-gray-700">
      <div className="px-6 mx-auto h-screen pt-6">
          ...
          <div className='flex justify-between mt-10'>
            <div>
              <a href='/teachers' className=' text-white bg-yellow-600 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-3 py-1 text-center text-lg mr-4'>Teachers</a>
                      ...
                      if(type === 'teacher') {
                        return (
                            <tr key={ind} className='my-2'>
                              ...
                              <td>{addresss}</td>
                              <td>
                                <a href={`/teacher/edit/${_id}`} className='text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium  px-3 py-1 text-center text-md mr-2'>Edit</a>
