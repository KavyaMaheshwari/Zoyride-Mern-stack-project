                ...
                <div className="w-full rounded-lg shadow border max-w-md bg-gray-800 border-gray-700">
                    <div className="p-6 space-y-6">
                        <form className="space-y-6" action="post">
                            ...
                            <div className='flex justify-between'>
                                <button onClick={handleSave} type="submit" className="mr-4 w-full text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-primary-700 focus:ring-primary-800">Save</button>
